---
title: "Final Practice (Solutions)"
subtitle: "Section 01"
format:
  html:
...
1.  Use the `read_csv()` and `here()` functions to import the following two CSV files from the "data/what_a_waste/" directory:
...
3.  Write a meaningful commit message (e.g. "Completed week 7 homework section 1") in the **Commit message** box
