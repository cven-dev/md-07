...
3.  Why does the resulting data object have data for 326 cities and not for the identified number of cities with population data in Point 1?
...
# Answer to question 3 (write your answer as a comment):
...
3.  Write a meaningful commit message (e.g. "Completed week 7 homework section 2") in the **Commit message** box
4.  Click **Commit**. Note that every commit needs to have a commit message associated with it.
5.  Click **Push** to send your changes to GitHub.
6.  Go to your md-07-USERNAME GitHub repo (where USERNAME is your GitHub username) and refresh the page. You should see your commit message next to the updated files.

## Open an issue on GitHub

Once you have ensured that the Quarto document renders without errors and you have pushed all your changes to GitHub, it is to complete the assignment by opening an issue on your md-07-USERNAME GitHub repo (where USERNAME is your GitHub username).

1.  Navigate to your md-07-USERNAME GitHub repo (where USERNAME is your GitHub username).
